...
if (choice.equals("athlete")){
    ...
    int i=1;
     System.out.println("Type \n1 to edit your profile \n2 to view it \n3See a Chat \n4 Send a message");
		...
		if (i == 1) {
            ...
            do{
             ...
             System.out.println("Wrong. Pick 1:position, 2:current_team, 3:height, 4:weight");
     ...
     //prepei na allaksoume thesi thn apo katw edoli
    ...
    CoachActions coachact = new CoachActions(athletesearray, coach,athletesearray.size());
     System.out.println("Type \n1 to edit your profile \n2 to view it \n3 to search for athletes \n4 See a Chat \n5 Send a message");
		...
		if (i == 1) {
            ...
            System.out.println("Wrong. Pick 1:years_of_experience or 2:team ");
            }while(num!=1 && num!=2);
			if (num == 1 ) {
				System.out.println("insert the new value");
